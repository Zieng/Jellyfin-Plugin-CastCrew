...
- Assembly metadata is auto-generated by the SDK from `.csproj` properties (`Version`, `Company`, `Product`, `Description`). The CI workflow overrides `Version` via `-p:Version=` from the git tag.
